...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 15 2017 г., 02:22
...
(5, 'multcbgq5e7gmf7i8iagpc0o44', 2, 1, '2017-12-15 02:01:17');
...
(1, '2016-12-11', 'Новогодняя акция!', 'С 20 по 31 декабря новогодние скидки до 70%, спешите купить!'),
(2, '2017-10-08', 'Для оптивиков', 'Для оформления заказа необходимо предоставить документ о регистрации.'),
(4, '2016-08-21', 'Спасибо от Сбербанка!', 'С 10 января при покупке товара начисляется бонусы спасибо в размере 5% от покупки.'),
(6, '2016-05-01', 'Распродажа аксессуаров для авто!', 'С 01 сентября по 01 ноября действует скидка 15% на весь товар.'),
(7, '2015-06-21', 'Поступление новых товаров!', 'В магазине новое поступление запчастей. Успевайте!');
...
(1, 1, '2015-01-16 18:25:34', 'Иванов И.И.', 'ivanII@mail.ru', '8-923-215-44-22', 'г. Воронеж, ул. Иваново дом3', '1hsbg98poo90hft01blar3o2r7'),
(2, 1, '2015-01-17 07:27:41', 'Сидорова Ирма Викторовна', 'sidorIV@mail.ru', '8-961-152-66-42', 'г. Воронеж, ул. Иваново дом3', 'lao13psinu1morl5nv2dciept7'),
(3, 0, '2015-01-26 01:50:08', 'Иванов И.И.', 'ivanII@mail.ru', '8 951 203 45 26', 'г. Москва, ул.Ленина дом8', '577bq4e5igmt7kbr8ebhsa6413'),
(4, 0, '2015-01-26 20:08:50', 'Петровская Марина Михайловна', 'mihaylova@mail.ru', '8 952 123 45 75', 'ул. Кирова 8-6', 's6gdudru2g32dp666ulaqhf9i5'),
(5, 0, '2015-01-26 20:20:01', 'Миронова Олеся', 'mironO@yandex.ru', '8 923 161 2213', 'г. Воронеж, ул. Смирнова дом 5', 'c5r3nrp9b4qjrgaggnlgkd2bm5'),
(6, 0, '2015-01-26 20:22:52', 'Романов Егор', 'egor51@mail.ru', '76-15-23', 'г. Воронеж, ул. Кирова 15-162', 'c5r3nrp9b4qjrgaggnlgkd2bm5'),
(7, 1, '2015-02-07 02:32:05', 'Соловьева Олеся Ивановна', 'solovOI@yandex.ru', '8-952-162-44-55', 'г. Воронеж, ул. Смирнова 5-16', 'pt9g9ib0j63pucvhgpd64neab5'),
(8, 0, '2016-02-10 14:16:18', 'Иванов И.И.', 'ivanII@mail.ru', '8-923-215-44-22', 'г. Воронеж, ул. Иваново дом3', 'o6u8paf9mmnle9l8hi8dno49j6');
